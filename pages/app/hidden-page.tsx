...
export async function getServerSideProps(context) {
  ...
  if (!supabaseToken) {
    throw new Error("It should not happen! Since this page is guarded by _middleware.ts, the presence of supabase token cookie (sb:token) should be already checked")
  }
  return {
    props: {
